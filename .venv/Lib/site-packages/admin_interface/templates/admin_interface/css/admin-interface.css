...
{
    theme . css_header_background_color
}
}
;
color: {
...
{
    theme . css_header_link_hover_color
}
}
;
...
{
    theme . css_module_background_color
}
}
;
color: {
...
{
    theme . css_module_link_hover_color
}
}
;
}
...
{
    theme . css_generic_link_hover_color
}
}
;
}
...
{
    theme . css_save_button_background_color
}
}
;
color: {
...
{
    theme . css_save_button_text_color
}
}
;
}
...
{
    theme . css_delete_button_text_color
}
}
;
}
